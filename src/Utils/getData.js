...
const API_KEY = 'fdyjyD2XskiXjlWqEtPAXkZ2KhdMSG8f'
const URL = 'https://dataservice.accuweather.com/'

const autocomplete = async (chosenCity) => {
  const autocompleteRes = await axios.get(URL +'locations/v1/cities/autocomplete?apikey=fdyjyD2XskiXjlWqEtPAXkZ2KhdMSG8f&q=' + chosenCity)
